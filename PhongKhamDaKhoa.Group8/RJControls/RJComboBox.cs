...
namespace PhongKham.RJControls
{
    ...
    public class RJComboBox : UserControl
    {
        ...
        public event EventHandler SelectedValueChanged;//Default                           //Event
        ...
        public RJComboBox()
        {
            ...
            cmbList.SelectedValueChanged += new EventHandler(ComboBox_SelectedValueChanged); // Thêm sự kiện SelectedValueChanged
        ...
        {
            cmbList.Width = lblText.Width + 30;
        ...
        {
            // Cập nhật Label.Text bằng ComboBox.Text
            lblText.Text = cmbList.Text;
        }
